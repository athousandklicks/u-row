                ...
                <div class="container-fluid"> 
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Inventory <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li class="active"><a href="demo.html">Select View Demo</a></li>
                    ...
                    <div class="content-wrap">
                        <div class="row car_listings">
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                ...
                                <img src="images/car-4-200x150.jpg" class="preview" alt="preview">
                                <table class="options-primary">
                                    <tr>
                                        <td class="option primary">Body Style:</td>
                                        <td class="spec">Convertible</td>
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                ...
                                <img src="images/car-5-200x150.jpg" class="preview" alt="preview">
                                <table class="options-primary">
                                    <tr>
                                        <td class="option primary">Body Style:</td>
                                        <td class="spec">Convertible</td>
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                ...
                                <img src="images/car-6-200x150.jpg" class="preview" alt="preview">
                                <table class="options-primary">
                                    <tr>
                                        <td class="option primary">Body Style:</td>
                                        <td class="spec">Sedan</td>
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                ...
                                <img src="images/car-7-200x150.jpg" class="preview" alt="preview">
                                <table class="options-primary">
                                    <tr>
                                        <td class="option primary">Body Style:</td>
                                        <td class="spec">Sport Utility Vehicle</td>
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect car_sold fadeIn">
                                ...
                                <img src="images/car-8-200x150.jpg" class="preview" alt="preview">
                            ...
                            <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                ...
                                <img src="images/car-9-200x150.jpg" class="preview" alt="preview">
                                <table class="options-primary">
                                    <tr>
                                        <td class="option primary">Body Style:</td>
                                        <td class="spec">Convertible</td>
                ...
                <div class="tab-pane fade" id="list-right-sidebar">
                    <div class="row">
                        <div class="inventory-wide-sidebar-right">
                            <div class="col-md-9">
                                <div class="sidebar car_listings margin-top-20 clearfix">
                                    <data></data>iv class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
