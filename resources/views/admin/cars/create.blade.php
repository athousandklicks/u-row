    ...
    <div class="row contacts margin-top-5"> 
        ...
        <div class="col-md-6 col-lg-offset-3 col-md-offset-3 padding-right-none xs-padding-left-none sm-padding-left-none xs-margin-top-30">
            <div class="contact_wrapper information_head">
                <h3 class="margin-bottom-25 margin-top-none">Add Car to Inventory</h3>

                <div class="form_contact margin-bottom-20">
                    <div id="result"></div>

                    {!! Form::open(['route' => 'car.store', 'method' => 'POST', 'files' => true, 'data-parsley-validate'=>'']) !!}
                    ...
                    <fieldset id="contact_form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {{Form::select('body_style', $body_style, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Body Style'])}}

                            </div>
                            <div class="col-md-6">
                                {{Form::label('drivetrain', 'Drivetrain')}}
                                {{Form::select('drivetrain', $drivetrain, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Drivetrain'])}}
                            </div>
                        </div>
                        <hr></hr>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                {{Form::select('year', $year, null, ['class' => 'form-control margin-bottom-30', 'placeholder'=>'Year'])}}
                            </div>

                            <div class="col-md-4">
                                {{Form::label('country', 'Country')}}
                                {{Form::select('country', $country, null, ['class' => 'form-control margin-bottom-30', 'placeholder'=>'Country'])}}
                            </div>

                            <div class="col-md-4">
                                {{Form::label('fuel_type', 'fuel Type')}}
                                {{Form::select('fuel_type', $fuel_type, null, ['class' => 'form-control margin-bottom-30', 'placeholder'=>'Fuel Type'])}}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                {{Form::select('transmission', $transmission, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Transmission'])}}
                            </div>
                            <div class="col-md-4">
                                {{Form::label('doors', 'Doors')}}
                                {{Form::select('doors', $door, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Doors'])}}
                            </div>
                            <div class="col-md-4">
                                {{Form::label('passengers', 'Passengers')}}
                                {{Form::select('passengers', $passenger, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Passengers'])}}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {{Form::select('status', $status, null, ['class' => 'form-control margin-bottom-30', 'placeholder'=>'Status'])}}
                            </div>

                            <div class="col-md-6">
                                {{Form::label('promo_phrase', 'Promo Phrase *')}}
                                {{Form::select('promo_phrase', $promo_phrase, null, ['class' => 'form-control margin-bottom-30', 'placeholder'=>'Promo Phrase '])}}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {{Form::select('condition', $condition, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'Condition '])}}
                            </div>
                            <div class="col-md-6">
                                {{Form::label('special_offer', 'Special Offer')}}
                                {{Form::select('special_offer', $special_offer, null, ['class' => 'form-control margin-bottom-70', 'placeholder'=>'special Offer '])}}  
                            </div>
                        </div>
                        ...
                        {{Form::submit('Create Product', ['class'=>'btn btn-primary submit_btn'])}}
                    </div>
                </div>
