			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
					<div class="panel panel-default">
						<div class="panel-heading"><h4>Edit Body Style</h4></div><!-- Default panel contents -->

						<div class="col-md-12 col-md-offset-1 top-clear-fix"><!-- Table -->
							
						{!!Form::model($passengers, ['route'=>['passenger.update', $passengers->id], 'method' => 'PUT'])!!}

							<div class="form-group">
								{{Form::label('name', 'Edit Body Style')}}
								{{ Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Edit Body Style Name']) }}
							</div>
